...
$this->includeJsFile('module.glaber.problems.view.js.php');

$this->enableLayoutModes();
$web_layout_mode = $this->getLayoutMode();

$widget = (new CHtmlPage())
	->setTitle(_('Problems view'))
...
if (isset($data['hosts']) && 1 == count( $data['hosts']) ) {
	...
	$widget->setNavigation(getHostNavigation('Problems view', $hostid));
...
if ($web_layout_mode == ZBX_LAYOUT_NORMAL) {
	...
	$widget->addItem((new CFilter((new CUrl('zabbix.php'))->setArgument('action', 'problem.view')))
		->setProfile('web.problems.filter')
...
$widget->addItem(new CPartial('module.glaber.problems.view.html', $data));
