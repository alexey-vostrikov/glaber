...
class CXmlConstantValue {
	...
	const ITEM_TYPE_WORKER_SERVER = ITEM_TYPE_WORKER_SERVER;
	...
	const DISCARD_AGGREGATE = GLB_PREPROC_THROTTLE_TIMED_VALUE_AGG;
	const DISPATCH_ITEM = GLB_PREPROC_DISPATCH_ITEM;
	const DISPATCH_ITEM_BY_IP = GLB_PREPROC_DISPATCH_ITEM_BY_IP;
	const DISPATCH_LOCAL = GLB_PREPROC_LOCAL_DISPATCH;
	const PREPROC_DISCOVERY_PREPARE = GLB_PREPROC_DISCOVERY_PREPARE;
	const PREPROC_JSON_FILTER = GLB_PREPROC_JSON_FILTER;
