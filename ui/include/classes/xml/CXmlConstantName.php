...
class CXmlConstantName {
	...
	const DISCARD_AGGREGATE = 'DISCARD_AGGREGATE';
	const DISPATCH_ITEM = 'DISPATCH_ITEM';
	const DISPATCH_ITEM_BY_IP = 'DISPATCH_ITEM_BY_IP';
	const DISPATCH_LOCAL = 'DISPATCH_LOCAL';
	const PREPROC_DISCOVERY_PREPARE = 'PREPROC_DISCOVERY_PREPARE';
	const PREPROC_JSON_FILTER = 'PREPROC_JSON_FILTER';
