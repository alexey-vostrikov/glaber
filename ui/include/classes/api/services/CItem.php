...
class CItem extends CItemGeneral {
	...
	public const SUPPORTED_PREPROCESSING_TYPES = [
		...
		GLB_PREPROC_JSON_FILTER, GLB_PREPROC_DISCOVERY_PREPARE, GLB_PREPROC_LOCAL_DISPATCH
	];
	...
	protected static function validateCreate(array &$items): void {
		...
		$api_input_rules = ['type' => API_OBJECTS, 'flags' => API_ALLOW_UNEXPECTED, 'uniq' => [['uuid'], ['hostid', 'key_']], 'fields' => [
			...
			'trends' =>			['type' => API_TIME_UNIT, 'flags' => API_NOT_EMPTY | API_ALLOW_USER_MACRO, 'in' => '0,'.implode(':', [SEC_PER_HOUR, 25 * SEC_PER_YEAR]), 'length' => DB::getFieldLength('items', 'trends')],
