...
class CDiscoveryRule extends CItemGeneralOld {
	 ...
	 * @var array
	 */
	const SUPPORTED_PREPROCESSING_TYPES = [ZBX_PREPROC_REGSUB, ZBX_PREPROC_JSONPATH, GLB_PREPROC_THROTTLE_TIMED_VALUE_AGG,
	    GLB_PREPROC_DISPATCH_ITEM, GLB_PREPROC_DISPATCH_ITEM_BY_IP, GLB_PREPROC_LOCAL_DISPATCH, 
		GLB_PREPROC_JSON_FILTER, GLB_PREPROC_DISCOVERY_PREPARE,
