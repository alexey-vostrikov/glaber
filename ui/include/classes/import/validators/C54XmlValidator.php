...
class C54XmlValidator extends CXmlValidatorGeneral {
	...
	private $PREPROCESSING_STEP_TYPE = [
		...
		CXmlConstantValue::DISPATCH_LOCAL => CXmlConstantName::DISPATCH_LOCAL,
		CXmlConstantValue::PREPROC_DISCOVERY_PREPARE => CXmlConstantName::PREPROC_DISCOVERY_PREPARE,
		CXmlConstantValue::PREPROC_JSON_FILTER => CXmlConstantName::PREPROC_JSON_FILTER,
	...
	private $ITEM_TYPE = [
		...
		CXmlConstantValue::ITEM_TYPE_WORKER_SERVER => CXmlConstantName::WORKER_SERVER,
