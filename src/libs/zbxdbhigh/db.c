 ...
 *                                                                            *
 ******************************************************************************/
static void	zbx_db_add_condition_alloc_btw(char **sql, size_t *sql_alloc, size_t *sql_offset, const char *fieldname,
		...
		const zbx_uint64_t *values, const int num)
{
	...
	zbx_chrcpy_alloc(sql, sql_alloc, sql_offset, ' ');
#ifdef HAVE_ORACLE
	zbx_db_add_condition_alloc_btw(sql, sql_alloc, sql_offset, fieldname, values, num, &seq_len, &seq_num, &in_num,
			&between_num);
...
/******************************************************************************
 *                                                                            *
 * Purpose: This function is similar to zbx_db_add_condition_alloc(), except it is *
