...
int	get_process_type_forks(unsigned char proc_type)
{
	switch (proc_type)
	{
		case ZBX_PROCESS_TYPE_POLLER:
			return CONFIG_POLLERS_FORKS[ZBX_POLLER_TYPE_NORMAL];
		case ZBX_PROCESS_TYPE_ASYNC_AGENT:
			return CONFIG_POLLERS_FORKS[ZBX_POLLER_TYPE_ASYNC_AGENT];
		case ZBX_PROCESS_TYPE_ASYNC_SNMP:
			return CONFIG_POLLERS_FORKS[ZBX_POLLER_TYPE_ASYNC_SNMP];
		case ZBX_PROCESS_TYPE_UNREACHABLE:
			return CONFIG_POLLERS_FORKS[ZBX_POLLER_TYPE_UNREACHABLE];
		case ZBX_PROCESS_TYPE_IPMIPOLLER:
			return CONFIG_POLLERS_FORKS[ZBX_POLLER_TYPE_IPMI];
		case ZBX_PROCESS_TYPE_PINGER:
			return CONFIG_POLLERS_FORKS[ZBX_POLLER_TYPE_PINGER];
		case ZBX_PROCESS_TYPE_JAVAPOLLER:
			return CONFIG_POLLERS_FORKS[ZBX_POLLER_TYPE_JAVA];
