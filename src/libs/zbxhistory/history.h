...
typedef int (*glb_history_add_func_t)(void *data, metric_t *metric, metric_processing_data_t *proc_data);
...
typedef int (*glb_history_add_trend_func_t)(void *data, trend_t *trend, metric_processing_data_t *proc_data);
