	...
	for (i = 0; i < num; i++)
	{
		switch (errcodes[i])
		{
			case SUCCEED:
				...
				zbx_preprocess_item_value(items[i].host.hostid, items[i].itemid, items[i].host.hostid, items[i].value_type, items[i].flags,
			...
			case NOTSUPPORTED:
				...
				zbx_preprocess_item_value(items[i].host.hostid, items[i].itemid, items[i].host.hostid, items[i].value_type, items[i].flags, NULL,
