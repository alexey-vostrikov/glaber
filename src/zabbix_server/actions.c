...
/******************************************************************************
 *                                                                            *
 * Purpose: check if problem matches single condition                           *
 *                                                                            *
 ...
 *                                                                            *
 ******************************************************************************/
static void	check_trigger_condition(u_int64_t problemid, zbx_condition_t *condition)
{
	int	ret;
...
void glb_actions_process_problem_recovery(u_int64_t problemid) {

}
void glb_actions_process_discovery() {

}
void glb_actions_process_lld() {

}
void glb_actions_process_autoregister() {
}
