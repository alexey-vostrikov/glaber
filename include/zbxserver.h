...
int	zbx_substitute_simple_macros(const zbx_uint64_t *actionid, const calc_trigger_t *trigger, 
...
int	zbx_substitute_simple_macros_unmasked(const zbx_uint64_t *actionid, const calc_trigger_t *trigger,
...
void	zbx_prepare_triggers(calc_trigger_t **triggers, int triggers_num);
...
void	zbx_expression_eval_resolve_trigger_hosts_items(zbx_expression_eval_t *eval, const calc_trigger_t *trigger);
