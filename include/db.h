...
#define ZBX_FLAGS_TRIGGER_DIFF_UPDATE_TIMER_REVISION			0x0010
#define ZBX_FLAGS_TRIGGER_DIFF_UPDATE_ALL										\
		(ZBX_FLAGS_TRIGGER_DIFF_UPDATE_VALUE | ZBX_FLAGS_TRIGGER_DIFF_UPDATE_LASTCHANGE | 		\
		ZBX_FLAGS_TRIGGER_DIFF_UPDATE_STATE | ZBX_FLAGS_TRIGGER_DIFF_UPDATE_ERROR | ZBX_FLAGS_TRIGGER_DIFF_UPDATE_TIMER_REVISION )
